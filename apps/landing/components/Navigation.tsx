    ...
    <nav className="fixed top-0 w-full z-50 bg-[#09090b]/80 backdrop-blur-xl border-b border-zinc-800/50">
      <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
        <Link href="/" className="flex items-center">
          <Image src="/logo-white.png" alt="SmithKit" width={140} height={40} className="h-7 w-auto" />
        </Link>
        ...
        <div className="hidden md:flex items-center gap-4">
          ...
          <Link 
            ...
            className="px-4 py-2 rounded-lg bg-gradient-to-r from-purple-600 to-fuchsia-600 text-sm font-medium hover:opacity-90 transition-opacity"
          >
            Get Started
          </Link>
        </div>
        ...
        <div className="md:hidden bg-[#09090b] border-b border-zinc-800">
          <div className="px-6 py-4 space-y-4">
            ...
            <div className="pt-4 border-t border-zinc-800 space-y-3">
              ...
              <Link href={`${DASHBOARD_URL}/login`} onClick={() => setIsOpen(false)} className="block px-4 py-3 rounded-lg bg-gradient-to-r from-purple-600 to-fuchsia-600 text-center font-medium">Get Started</Link>
            </div>
          </div>
        </div>
      )}
